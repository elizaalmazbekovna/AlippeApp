import 'package:alippe_app/models/event_info.dart';
import 'package:alippe_app/resources/color.dart';
import 'package:alippe_app/screens/create_screen.dart';
import 'package:alippe_app/screens/edit_screen.dart';
import 'package:alippe_app/utils/storage.dart';
              ...
              if (snapshot.hasData && snapshot.data!.docs.isNotEmpty) {
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    Map<String, dynamic> eventInfo = snapshot.data!.docs[index]
